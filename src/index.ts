// Ambient declarations for build-time replaceable constants.
// Exposed from the package's main types entry so consumers don't need to add
// `@prostojs/dye/global` to compilerOptions.types — importing anything from
// `@prostojs/dye` is enough to make these visible.
/* eslint-disable no-var, vars-on-top */
declare global {
  var __DYE_RESET__: string
  var __DYE_COLOR_OFF__: string
  var __DYE_BG_OFF__: string
  var __DYE_BOLD__: string
  var __DYE_BOLD_OFF__: string
  var __DYE_DIM__: string
  var __DYE_DIM_OFF__: string
  var __DYE_ITALIC__: string
  var __DYE_ITALIC_OFF__: string
  var __DYE_UNDERSCORE__: string
  var __DYE_UNDERSCORE_OFF__: string
  var __DYE_INVERSE__: string
  var __DYE_INVERSE_OFF__: string
  var __DYE_HIDDEN__: string
  var __DYE_HIDDEN_OFF__: string
  var __DYE_CROSSED__: string
  var __DYE_CROSSED_OFF__: string

  var __DYE_BLACK__: string
  var __DYE_BG_BLACK__: string
  var __DYE_BLACK_BRIGHT__: string
  var __DYE_BG_BLACK_BRIGHT__: string
  var __DYE_RED__: string
  var __DYE_BG_RED__: string
  var __DYE_RED_BRIGHT__: string
  var __DYE_BG_RED_BRIGHT__: string
  var __DYE_GREEN__: string
  var __DYE_BG_GREEN__: string
  var __DYE_GREEN_BRIGHT__: string
  var __DYE_BG_GREEN_BRIGHT__: string
  var __DYE_YELLOW__: string
  var __DYE_BG_YELLOW__: string
  var __DYE_YELLOW_BRIGHT__: string
  var __DYE_BG_YELLOW_BRIGHT__: string
  var __DYE_BLUE__: string
  var __DYE_BG_BLUE__: string
  var __DYE_BLUE_BRIGHT__: string
  var __DYE_BG_BLUE_BRIGHT__: string
  var __DYE_MAGENTA__: string
  var __DYE_BG_MAGENTA__: string
  var __DYE_MAGENTA_BRIGHT__: string
  var __DYE_BG_MAGENTA_BRIGHT__: string
  var __DYE_CYAN__: string
  var __DYE_BG_CYAN__: string
  var __DYE_CYAN_BRIGHT__: string
  var __DYE_BG_CYAN_BRIGHT__: string
  var __DYE_WHITE__: string
  var __DYE_BG_WHITE__: string
  var __DYE_WHITE_BRIGHT__: string
  var __DYE_BG_WHITE_BRIGHT__: string

  var __DYE_GRAY01__: string
  var __DYE_BG_GRAY01__: string
  var __DYE_GRAY02__: string
  var __DYE_BG_GRAY02__: string
  var __DYE_GRAY03__: string
  var __DYE_BG_GRAY03__: string
  var __DYE_GRAY04__: string
  var __DYE_BG_GRAY04__: string
  var __DYE_GRAY05__: string
  var __DYE_BG_GRAY05__: string
  var __DYE_GRAY06__: string
  var __DYE_BG_GRAY06__: string
  var __DYE_GRAY07__: string
  var __DYE_BG_GRAY07__: string
  var __DYE_GRAY08__: string
  var __DYE_BG_GRAY08__: string
  var __DYE_GRAY09__: string
  var __DYE_BG_GRAY09__: string
  var __DYE_GRAY10__: string
  var __DYE_BG_GRAY10__: string
  var __DYE_GRAY11__: string
  var __DYE_BG_GRAY11__: string
  var __DYE_GRAY12__: string
  var __DYE_BG_GRAY12__: string
  var __DYE_GRAY13__: string
  var __DYE_BG_GRAY13__: string
  var __DYE_GRAY14__: string
  var __DYE_BG_GRAY14__: string
  var __DYE_GRAY15__: string
  var __DYE_BG_GRAY15__: string
  var __DYE_GRAY16__: string
  var __DYE_BG_GRAY16__: string
  var __DYE_GRAY17__: string
  var __DYE_BG_GRAY17__: string
  var __DYE_GRAY18__: string
  var __DYE_BG_GRAY18__: string
  var __DYE_GRAY19__: string
  var __DYE_BG_GRAY19__: string
  var __DYE_GRAY20__: string
  var __DYE_BG_GRAY20__: string
  var __DYE_GRAY21__: string
  var __DYE_BG_GRAY21__: string
  var __DYE_GRAY22__: string
  var __DYE_BG_GRAY22__: string
}
...
export type TDyeColor = (typeof DyeColors)[number]
export type TDyeGrayscale = (typeof DyeGrayscale)[number]
...
export type TDyeModifier = (typeof DyeModifier)[number]
...
export interface TDyeStylist<Format extends unknown[] = TConsoleArgument> {
  ...
  attachConsole: (
    ...args:
      | []
      | [TConsoleMethodName]
      | [TConsoleMethodName, TConsoleInterface]
      | [(...args: Format) => void]
  ) => TDyeStylistConsole<Format>
}
...
const plain = (...n: Codes[]) => `\u001B[${n.join(';')}m`
const gray = (n: Codes) => `\u001B[38;5;${n}m`
const bgGray = (n: Codes) => `\u001B[48;5;${n}m`
const rgb256 = (r: number6, g: number6, b: number6, bg = false) =>
  `\u001B[${38 + Number(bg) * BG_OFFSET};5;${16 + r * 36 + g * 6 + b}m`
const tcRGB = (r: number256, g: number256, b: number256, bg = false) =>
  `\u001B[${38 + Number(bg) * BG_OFFSET};2;${r};${g};${b}m`
...
type DyeFunction<Format extends unknown[] = TConsoleArgument> = (<F extends unknown[] = Format>(
  ...args: TDyeAll[]
) => TDyeStylist<F>) & {
...
// implementation
export const dye = (<Format extends unknown[] = TConsoleArgument>(
  ...args: TDyeAll[]
): TDyeStylist<Format> => {
  const openStack: Array<string | number> = []
  const openColorsStack: Array<string | number> = []
  const openBgColorsStack: Array<string | number> = []
  const openModifiersStack: Array<string | number> = []
    ...
    for (const c of args) {
      if (c.indexOf(',') > 0 || c.includes('#')) {
        ...
        if (c.includes('#')) {
          ...
          let hex = c.split('#').pop()!
          if (!/^([0-9a-f]{3}|[0-9a-f]{6})$/iu.test(hex)) {
            throw new Error(`[Dye] Wrong hex "#${hex}".`)
          }
          if (hex.length === 3) {
          ...
          let mode256 = false
          let [r, g, b]: Array<string | number> = c.split(',')
          if (r.startsWith('bg')) {
            bg = true
            r = r.slice(2)
          }
  ...
  function collapseStack(stack: Array<number | string>): string {
    let modStack = []
    let result = ''
  ...
  const close = closingCodes.length > 0 ? plain(...closingCodes) : ''
...
dye.strip = (coloredText: string): string => coloredText.replace(/\x1B\[[^m]+m/gu, '')
...
function getStylist<Format extends unknown[] = TConsoleArgument>(
  ...
  const formatDefault = (...texts: Format): string => texts.map(String).join(' ')
  ...
  stylist.open = open
  stylist.close = close
  stylist.format = (cb: (...texts: Format) => string) =>
    getStylist<Format>(open, close, prefix, suffix, parts, cb)
  stylist.prefix = (v: string | (() => string)) =>
    getStylist<Format>(open, close, v, suffix, parts, format)
  stylist.suffix = (v: string | (() => string)) =>
    getStylist<Format>(open, close, prefix, v, parts, format)
  stylist.attachConsole = (
    ...args:
      | []
      | [TConsoleMethodName]
      | [TConsoleMethodName, TConsoleInterface]
    ...
    if (typeof args[0] === 'string' || args[0] === undefined) {
      consoleMethod = consoleInterface[args[0]! || 'log']
    ...
    const dyeConsole: TDyeStylistConsole<Format> = (...consoleArgs: Format) => {
      if (enabled) {
        ...
        if (format) {
          ...
          if (newArgs.length > 0) {
            consoleMethod(
              ...[start + first, ...newArgs, last + end].filter(e => typeof e !== 'string' || !!e)
            )
          } else {
...
function sanitizeString(source: string, parts: OpenParts): string {
  let result = source
  if (parts.openColors) {
    result = result.replace(/(\x1B\[[0-9;]*39[0-9;]*m)/gu, `$1${parts.openColors}`)
  }
  if (parts.openBgColors) {
    result = result.replace(/(\x1B\[[0-9;]*49[0-9;]*m)/gu, `$1${parts.openBgColors}`)
  }
  if (parts.openModifiers) {
    result = result.replace(/(\x1B\[(?:22|23|24)m)/gu, `$1${parts.openModifiers}`)
  }
  return result
}
...
function checkRGBNumber(n: number | string, component: 'r' | 'g' | 'b', limit = 255): number {
  const _n = Number(n)
  if (Number.isNaN(_n)) {
    throw new TypeError(`[Dye] Color component "${component}" must be a number. Received "${n}".`)
  }
  if (_n > limit) {
    throw new Error(
      `[Dye] Color component "${component}" must be less than ${limit + 1}. Received "${n}".`
    )
  }
  return _n
}
